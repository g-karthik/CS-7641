...
%	[class, centroid] = kmeans(pixels, K);
    ...
    while iter < maxIterations
        ...
        for i=1:K
            clusterCenters(i,:) = sumOfClusterDP(i,:) / countOfClusterDP(i);
        end
    ...
    if iter < maxIterations
        fprintf('mykmeans converged before max iterations limit\n');
    else
        fprintf('mykmeans max iterations limit reached\n');
    end
